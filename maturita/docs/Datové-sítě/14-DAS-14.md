...
- Pole Délka/Typ může být použito dvěma způsoby
    - Hodnoty 1500 a menší znamenají, že se jedná o délku pole v oktetech
...
> Kódování Manchester je změna z vysoké úrovně na nízkou úroveň = 1, nízké na vysokou = 0 ale v ethernetu se využívala invertovaná verze kde nízké -> vysoké = 1 a vysoké -> nízké = 0
