...
- smaěruje packety meziu sítěmi
- na každém portu (i virtuálním) se nachází jiná síť
- fyzicky má zařízení méně portů 
- ve většině případů poskytuje sítí defaultní bránu
- pracuje s IP adresami

# Směrovací tabulka 
- obsahuje informace o cestách k jednotlivým sítím
- obsahuje informace o vzdálenosti a kvalitě cesty
- obsahuje informace o připojených sítích
- na třetí vrstvě se tedy využívá pro zjištění cesty k cílové síti
