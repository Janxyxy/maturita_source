...
- u OSPF je ten DR a BDR
  - dva důležité routery -> každý router posílá updaty když zachytí změnu.. v multipoint sítích (když SW spojuje více routerů) by tím ale mohla vzniknout taková malá bouře (hromadné přeposílání updatů, které by vlastně byly duplikátní... takže se volí ten DR.. jenom updaty od DR budou považované za správné a budou zpracované.. všechny ostatní updaty budou ignorovaný.. BDR je zástupce
