...
> rozdílem je že aktivní prvky se signálem pracují, zpracovávají nebo modifikují, zpravidla je potřeba je napájet. Pasivní prvky naopak signál pouze přenášejí.
...
je postupné zabalování dat do zprávy právě pomocí protokolů. Při každém kroku se k datům přidají informace které jsou v daném kroku potřeba, tak aby zpráva došla správně.
