...
## 1. Počítačová síť
označení pro prostředky a metody, které umožňují zařízením propojit se tak, aby mohla vzájemně komunikovat a vyměňovat si informace.

Vznikla díky potřebě lidí, komunikovat, předávat si informace a spolupracovat.

aby mohla komunikace probíhat, musí všechna zařízení dodržovat určitá pravidla:
...
- Vynález knihtisku
- Vynález telegrafu - ulehčení vzdálenější komunikace
- Vynález bezdrátového přenosu (rádiové vlny)
