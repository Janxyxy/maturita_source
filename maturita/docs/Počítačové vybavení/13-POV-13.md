...
-	Proces popisujeme z různých pohledů, které se navzájem doplňují
 ### 3 základní pohledy
### Genetický -	Proces je instancí programu
...
-	Ve stavu sleeping se může nacházet více procesů čekajících na stejný vyhrazený prostředek
...
## Multitasking
-	Správa procesů
-	Více souběžně běžících vláken v jednom procesu
...
-	Volá v nekonečném cyklu dispečera, který vybírá procesy ke připuštění na procesor
