...
- Virtualizace **NENÍ** jediným správcem paměti a musí být doplněna klasickou správou OP. Ta ovšem už nespravuje FAP, ale LAP.
...
- mezi LAP a FAP existuje neúplné zobrazení - vždy budou existovat stránky bez přiřazeného rámce - neplatné stránky.
...
- Tato rutina má dvě možnosti, jak se zachovat.
    1) Nalezne odpovídající rámec a zajistí jeho propojení se stránkou, kterou následně zplatní (V tabulce se uloží index rámce a nastaví se bit platnosti)
