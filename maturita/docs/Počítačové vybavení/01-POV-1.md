...
- **Rastrová grafika** – pevná velikost pixelu, obraz tvoří matice bodů (pixelů); při zvětšení dochází ke ztrátě kvality
- **Vektorová grafika** – obraz je definován vzájemnými pozicemi bodů a matematickými křivkami; lze libovolně zvětšovat bez ztráty kvality

# Zobrazení obrazu
## Typy zobrazení
- textový
    - historicky byla obrazovka rozdělena na políčka kde každé pole mohlo být jeden znak
...
- nejmenší jednotka digitální rastrové grafiky
    ...
    - každý pixel má vlastní souřadnice
...
### Princip
    ...
    Intenzita světla se mění v závislosti na velikosti napětí připojeného k elektrodám.
...
jenže barevné body stárnou – modrá složka degraduje nejrychleji, červená nejpomaleji (relativní porovnání, moderní OLED panely mají výrazně delší životnost než starší generace)

## Plazmové
- 1936 princip plazmové obrazovky
- 1983 první plazmová obrazovka
...
- Grafická karta generuje spoustu tepla a je nutné efektivní chlazení
    - pasivní
    - aktivní větráčky
    - vodní
...
- VGA
- HDMI
    - přenos videa ve standardní/HD kvalitě
...
- software tvorby obrazu např.
    - microsoft DirectX 12 (aktuální generace)
    - OpenGL
