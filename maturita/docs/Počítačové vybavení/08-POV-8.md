...
- Svobodný software
- Umožňuje volné šíření licencovaného obsahu, vyžaduje pouze uvedení autora a informaci o licenci

### MIT licence

- Svobodná licence, lze použít pro volně dostupný software s možností zasahování do kódu
- Lze použít i pro proprietární software (SW s uzavřeným kódem, autor upravuje licence EULA a často znemožňuje zasahování do kódu)
...
### Plná verze zdarma
- Nelze volně šířit, jedná se o neomezené komerční programy
### Adware
...
## Dělení citace1.	Přímá citace – V uvozovkách, často kurzívou, za citací musí být zdroj, využívat jen zřídka
...
- Využití PC v síti botnetu (zombie)
    - Zombie – počítač připojený k internetu a který je napaden virem
    - Může být využíván pro další počítačové úkoly
...
- Kus kódu vložený do aplikace, který jí může smazat / zablokovat
...
### Worms (červi)
- Šíří se formou síťových paketů (většinou emailové přílohy)
...
- Díky časnému zavedení je omezen na služby BIOSu
