...
- Nezávislost jednotlivých procesů 
    - Pro každý proces běžící v rámci OS musí rutiny OS vytvářet iluzi, že je jediným procesem, který kdy běžel, běží a bude běžet v rámci dané instance OS (instance OS vzniká bootováním systému a zaniká vypnutím PC)
...
- Základní klasifikace je dle úrovně spolupráce jednotlivých rutin OS
    - Monolitické - S těsným propojením rutin
...
- Tato architektura přináší plně distribuovaný přístup (pozornost na několik objektů současně, bohužel snižuje výkonnost systému)
