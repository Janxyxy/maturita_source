...
- ACOS: Vrátí arccosinus daného čísla.
...
### Hashovací funkce
- Hashovací funkce přijímá vstupní data libovolné délky a generuje z nich hash pevné délky, který je jedinečný pro každý vstup. 
...
- - Příklady: `CONCAT` - přidání soli k heslu 