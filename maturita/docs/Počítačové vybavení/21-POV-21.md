# Otázka č. 21 - Bloky, podmínky, cykly, kurzory a výjimky
...
3. **Výjimková část** - Slouží k zachycení a ošetření výjimek, které mohou nastat během vykonávání bloku.
...
- umožňuje zpracovat více podmínek a je podobná switch-case konstrukcím v jiných programovacích jazycích. 
